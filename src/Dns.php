...
class Dns
{
    ...
    public static function isValidIP6($value)
    {
     ...
     */
    public static function isReservedIp($target)
    {
     ...
     * @return mixed|null
     */
    public static function getIpFromServerArray(array $server = null, array $proxy_ips = null)
    {
        if ($server === null) {
            $server = $_SERVER;
        }
        ...
        return (array_key_exists('REMOTE_ADDR', $server) ? $server['REMOTE_ADDR'] : NULL);
    }
